...
````yaml openapi/dataforseo.json GET /dataforseo/serp/seznam/languages
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/seznam/languages:
    get:
      ...
      description: >-
        List of Seznam Languages for SERP. Returns the list of supported
        languages for Seznam SERP. Your account is not charged for using this
        endpoint.
