...
````yaml openapi/dataforseo.json GET /dataforseo/merchant/amazon/products/tasks_ready
openapi: 3.0.3
info:
...
paths:
  /dataforseo/merchant/amazon/products/tasks_ready:
    get:
      ...
      operationId: get_dataforseo_merchant_amazon_products_tasks_ready
      responses:
        '200':
              ...
              schema:
                ...
                properties:
                  ...
                  tasks.result.endpoint_advanced:
                    type: string
                    description: >-
                      URL for collecting the results of the Amazon Products
                      Advanced task
                  tasks.result.endpoint_html:
                    type: string
                    description: >-
                      URL for collecting the results of the Amazon Products HTML
                      task
        '400':
