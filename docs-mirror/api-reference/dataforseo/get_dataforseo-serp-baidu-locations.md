...
````yaml openapi/dataforseo.json GET /dataforseo/serp/baidu/locations
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/baidu/locations:
    get:
      ...
      description: >-
        List of Baidu Locations for SERP. Returns the list of supported
        locations for Baidu SERP. Your account is not charged for using this
        endpoint.
