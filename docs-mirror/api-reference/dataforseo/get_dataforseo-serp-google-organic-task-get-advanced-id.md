...
````yaml openapi/dataforseo.json GET /dataforseo/serp/google/organic/task_get/advanced/{id}
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/organic/task_get/advanced/{id}:
    get:
      ...
      description: >-
        Get Google Organic SERP Advanced Results by id. Retrieve advanced task
        results for a posted task within 30 days at no extra charge.
      operationId: get_dataforseo_serp_google_organic_task_get_advanced_id
      parameters:
        - name: id
          in: path
          required: true
