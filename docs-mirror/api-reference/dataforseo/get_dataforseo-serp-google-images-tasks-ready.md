...
````yaml openapi/dataforseo.json GET /dataforseo/serp/google/images/tasks_ready
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/images/tasks_ready:
    get:
      ...
      description: >-
        Get Images SERP Completed Tasks. Returns a list of completed tasks that
        have not been collected yet. Up to 1000 tasks completed within the
        previous 3 days can be returned per call.
      operationId: get_dataforseo_serp_google_images_tasks_ready
      responses:
        '200':
