...
````yaml openapi/dataforseo.json GET /dataforseo/serp/google/dataset_search/task_get/advanced/{id}
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/dataset_search/task_get/advanced/{id}:
    get:
      ...
      description: >-
        Get Google Dataset Search Advanced Results by id. You can retrieve
        completed task results by task id within the retention period.
      operationId: get_dataforseo_serp_google_dataset_search_task_get_advanced_id
      parameters:
        - name: id
          in: path
          required: true
