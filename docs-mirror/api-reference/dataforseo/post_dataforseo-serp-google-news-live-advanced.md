...
````yaml openapi/dataforseo.json POST /dataforseo/serp/google/news/live/advanced
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/news/live/advanced:
    post:
      ...
      description: >-
        Live Google News SERP. Returns Google News SERP results in real time.
        Each Live SERP API call can contain only one task.
      operationId: post_dataforseo_serp_google_news_live_advanced
      requestBody:
        required: true
        content:
          application/json:
