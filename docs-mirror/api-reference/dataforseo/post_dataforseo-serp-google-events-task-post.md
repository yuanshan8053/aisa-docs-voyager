...
````yaml openapi/dataforseo.json POST /dataforseo/serp/google/events/task_post
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/events/task_post:
    post:
      ...
      description: >-
        Setting Google Events SERP Tasks. Your account is charged only for
      ...
      operationId: post_dataforseo_serp_google_events_task_post
      requestBody:
        required: true
        content:
          application/json:
