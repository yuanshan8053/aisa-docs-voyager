...
````yaml openapi/dataforseo.json GET /dataforseo/serp/baidu/organic/task_get/html/{id}
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/baidu/organic/task_get/html/{id}:
    get:
      ...
      description: >-
        Get Baidu Organic HTML Results by id. Returns HTML results for a
        previously posted Baidu Organic task.
      operationId: get_dataforseo_serp_baidu_organic_task_get_html_id
      parameters:
        - name: id
          in: path
          required: true
