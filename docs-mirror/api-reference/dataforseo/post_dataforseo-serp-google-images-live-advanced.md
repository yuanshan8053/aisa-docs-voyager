...
````yaml openapi/dataforseo.json POST /dataforseo/serp/google/images/live/advanced
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/images/live/advanced:
    post:
      ...
      description: >-
        Live Google Images SERP. Returns Google Images SERP results in real
        time. Each Live SERP API call can contain only one task.
      operationId: post_dataforseo_serp_google_images_live_advanced
      requestBody:
        required: true
        content:
          application/json:
