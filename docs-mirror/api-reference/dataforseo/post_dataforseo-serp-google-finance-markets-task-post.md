...
````yaml openapi/dataforseo.json POST /dataforseo/serp/google/finance_markets/task_post
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/finance_markets/task_post:
    post:
      ...
      description: >-
        Setting Google Finance Markets SERP Tasks. Provides real-time data from
        the Markets tab of Google Finance for the specified location, language,
        and market type.
      operationId: post_dataforseo_serp_google_finance_markets_task_post
      requestBody:
        required: true
        content:
          application/json:
