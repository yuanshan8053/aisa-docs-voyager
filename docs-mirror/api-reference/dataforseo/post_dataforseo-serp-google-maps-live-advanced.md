...
````yaml openapi/dataforseo.json POST /dataforseo/serp/google/maps/live/advanced
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/maps/live/advanced:
    post:
      ...
      description: >-
        Live Google Maps SERP. Returns Google Maps SERP results in real time.
        Each Live SERP API call can contain only one task.
      operationId: post_dataforseo_serp_google_maps_live_advanced
      requestBody:
        required: true
        content:
          application/json:
