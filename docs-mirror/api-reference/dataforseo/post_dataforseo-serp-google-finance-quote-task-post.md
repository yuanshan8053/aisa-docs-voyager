...
````yaml openapi/dataforseo.json POST /dataforseo/serp/google/finance_quote/task_post
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/finance_quote/task_post:
    post:
      ...
      description: >-
        Setting Google Finance Quote SERP Tasks. Provides real-time data from
        the Quote tab of Google Finance for the specified ticker, location, and
        language.
      operationId: post_dataforseo_serp_google_finance_quote_task_post
      requestBody:
        required: true
        content:
          application/json:
            schema:
              ...
              properties:
                ...
                window:
                  type: string
                  description: >-
                    Time window for the quote graph, such as 1D, 5D, 1M, 6M,
                    YTD, 1Y, 5Y, or MAX
                priority:
                  type: integer
