...
````yaml openapi/dataforseo.json GET /dataforseo/business_data/tripadvisor/search/tasks_ready
openapi: 3.0.3
info:
  ...
  /dataforseo/business_data/tripadvisor/search/tasks_ready:
    get:
      ...
      description: >-
        ...
        **‘Task GET’** endpoint.
      operationId: get_dataforseo_business_data_tripadvisor_search_tasks_ready
      responses:
        '200':
