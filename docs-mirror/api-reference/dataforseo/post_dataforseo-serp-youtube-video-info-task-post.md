...
````yaml openapi/dataforseo.json POST /dataforseo/serp/youtube/video_info/task_post
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/youtube/video_info/task_post:
    post:
      ...
      description: >-
        Setting YouTube Video Info Tasks. Provides detailed information about
        the specified YouTube video. Your account is charged only for setting a
        task.
      operationId: post_dataforseo_serp_youtube_video_info_task_post
      requestBody:
        required: true
        content:
          application/json:
