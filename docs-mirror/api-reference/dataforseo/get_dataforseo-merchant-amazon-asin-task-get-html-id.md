...
````yaml openapi/dataforseo.json GET /dataforseo/merchant/amazon/asin/task_get/html/{id}
openapi: 3.0.3
info:
  ...
  /dataforseo/merchant/amazon/asin/task_get/html/{id}:
    get:
      ...
      description: >-
        ...
        GET
        https://api.dataforseo.com/v3/merchant/amazon/asin/task\_get/html/$id
      operationId: get_dataforseo_merchant_amazon_asin_task_get_html_id
      responses:
        '200':
