...
````yaml openapi/dataforseo.json GET /dataforseo/serp/baidu/languages
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/baidu/languages:
    get:
      ...
      description: >-
        List of Baidu Languages for SERP. Returns the list of supported
        languages for Baidu SERP. Your account is not charged for using this
        endpoint.
