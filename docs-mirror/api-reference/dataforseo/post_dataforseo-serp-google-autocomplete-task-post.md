...
````yaml openapi/dataforseo.json POST /dataforseo/serp/google/autocomplete/task_post
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/autocomplete/task_post:
    post:
      ...
      description: >-
        Setting Google Autocomplete Tasks. DataForSEO returns Google
        Autocomplete suggestions for a keyword, cursor position, and selected
        client. Your account is charged only for setting a task.
      operationId: post_dataforseo_serp_google_autocomplete_task_post
      requestBody:
        required: true
        content:
          application/json:
            schema:
              ...
              properties:
                ...
                client:
                  type: string
                  description: >-
                    Search client for autocomplete, such as chrome, chrome-omni,
                    gws-wiz, safari, firefox, img, or youtube
                location_name:
                  type: string
