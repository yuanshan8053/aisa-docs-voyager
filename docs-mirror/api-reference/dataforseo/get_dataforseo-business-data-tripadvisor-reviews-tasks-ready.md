...
````yaml openapi/dataforseo.json GET /dataforseo/business_data/tripadvisor/reviews/tasks_ready
openapi: 3.0.3
info:
  ...
  /dataforseo/business_data/tripadvisor/reviews/tasks_ready:
    get:
      ...
      description: >-
        ...
        **‘Task GET’** endpoint.
      operationId: get_dataforseo_business_data_tripadvisor_reviews_tasks_ready
      responses:
        '200':
                  ...
                  result.se:
                    ...
                    description: >-
                      *search engine specified when setting the task* can take
                      the following values: `tripadvisor`
                  result.se_type:
                    type: string
