...
````yaml openapi/dataforseo.json GET /dataforseo/serp/youtube/languages
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/youtube/languages:
    get:
      ...
      description: >-
        List of YouTube Languages for SERP. Returns the list of supported
        languages for YouTube SERP. Your account is not charged for using this
        endpoint.
