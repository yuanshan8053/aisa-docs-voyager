...
````yaml openapi/dataforseo.json GET /dataforseo/serp/google/finance_markets/tasks_ready
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/finance_markets/tasks_ready:
    get:
      ...
      description: >-
        Get Finance Markets SERP Completed Tasks. Returns completed Google
        Finance Markets tasks that have not been collected yet.
      operationId: get_dataforseo_serp_google_finance_markets_tasks_ready
      responses:
        '200':
