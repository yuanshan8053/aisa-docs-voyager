...
````yaml openapi/dataforseo.json POST /dataforseo/serp/google/finance_markets/live/html
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/finance_markets/live/html:
    post:
      ...
      description: >-
        Live Google Finance Markets SERP HTML. Returns raw HTML from the Markets
