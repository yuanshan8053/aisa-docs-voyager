...
````yaml openapi/dataforseo.json POST /dataforseo/dataforseo_labs/google/relevant_pages/live
openapi: 3.0.3
info:
...
paths:
  /dataforseo/dataforseo_labs/google/relevant_pages/live:
    post:
      ...
      description: >-
        This endpoint will provide you with rankings and traffic data for the
        web pages of the specified domain. You will be able to review each
        page’s ranking distribution and estimated monthly traffic volume from
        both organic and paid searches.
      operationId: post_dataforseo_dataforseo_labs_google_relevant_pages_live
      requestBody:
        required: true
        content:
          application/json:
                ...
                properties:
                  ...
                  tasks.result.metrics.organic.etv:
                    ...
                    description: >-
                      ...
                      to the page calculated as the product of CTR
                      (click-through-rate) and search volume values of all
                      keywords in the category that the page ranks for learn
                  ...
                  tasks.result.metrics.organic.estimated_paid_traffic_cost:
                    ...
                    description: >-
                      ...
                      running ads for all keywords in the category that a page
                  ...
                  tasks.result.metrics.organic.is_new:
                    ...
                    description: >-
                      ...
                      ranked elements were found for the page
                  ...
                  tasks.result.metrics.organic.is_lost:
                    ...
                    description: >-
                      ...
                      the page were previously presented in SERPs, but weren’t
                      found during the last check
                  ...
                  tasks.result.metrics.paid.etv:
                    ...
                    description: >-
                      ...
                      the page calculated as the product of CTR
                      (click-through-rate) and search volume values of all
                      keywords in the category that the page ranks for learn
                      more about how the metric is calculated in this help
                      center article
                  ...
                  tasks.result.metrics.paid.estimated_paid_traffic_cost:
                    ...
                    description: >-
                      ...
                      page ranks for learn more about how the metric is
                      calculated in this help center article
                  ...
                  tasks.result.metrics.featured_snippet.pos_4_10:
                    type: integer
                    description: >-
                      number of featured snippet items where the page ranks
                      #4-10
