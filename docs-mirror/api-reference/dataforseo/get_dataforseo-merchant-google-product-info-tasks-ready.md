...
````yaml openapi/dataforseo.json GET /dataforseo/merchant/google/product_info/tasks_ready
openapi: 3.0.3
info:
...
paths:
  /dataforseo/merchant/google/product_info/tasks_ready:
    get:
      ...
      operationId: get_dataforseo_merchant_google_product_info_tasks_ready
      responses:
        '200':
              ...
              schema:
                ...
                properties:
                  ...
                  tasks.result.se_type:
                    type: string
                    description: >-
                      type of search engine can take the following values:
                  ...
                  tasks.result.endpoint_advanced:
                    type: string
                    description: >-
                      URL for collecting the results of the Google Shopping
                      Product Specifications Advanced task
                  tasks.result.endpoint_html:
                    type: string
                    description: >-
                      URL for collecting the results of the Google Shopping
                      Product Specifications HTML task note: HTML is not
                      available for this endpoint, the value will be null
        '400':
