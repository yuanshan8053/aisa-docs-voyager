...
````yaml openapi/dataforseo.json GET /dataforseo/merchant/google/product_info/task_get/advanced/{id}
openapi: 3.0.3
info:
  ...
  /dataforseo/merchant/google/product_info/task_get/advanced/{id}:
    get:
      ...
      description: >-
        ...
        GET
        https://api.dataforseo.com/v3/merchant/google/product\_info/task\_get/advanced/$id
      operationId: get_dataforseo_merchant_google_product_info_task_get_advanced_id
      responses:
        '200':
