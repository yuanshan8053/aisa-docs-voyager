...
````yaml openapi/dataforseo.json GET /dataforseo/app_data/google/app_listings/categories
openapi: 3.0.3
info:
...
paths:
  /dataforseo/app_data/google/app_listings/categories:
    get:
      ...
      operationId: get_dataforseo_app_data_google_app_listings_categories
      responses:
        '200':
              ...
              schema:
                ...
                properties:
                  ...
                  tasks.result.count:
                    type: integer
                    description: >-
                      number of app listings that make up the supported app
                      category
        '400':
