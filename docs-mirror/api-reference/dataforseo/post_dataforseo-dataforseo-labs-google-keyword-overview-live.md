...
````yaml openapi/dataforseo.json POST /dataforseo/dataforseo_labs/google/keyword_overview/live
openapi: 3.0.3
info:
...
paths:
  /dataforseo/dataforseo_labs/google/keyword_overview/live:
    post:
      ...
      description: >-
        This endpoint provides Google keyword data for specified keywords. For
        each keyword, you will receive current cost-per-click, competition
        values for paid search, search volume, search intent, monthly searches,
        as well as SERP and backlink information. Additionally, you can obtain
        clickstream data, such as clickstream search volume, by specifying the
        `include_clickstream_data` parameter.
              ...
              schema:
                ...
                properties:
                  ...
                  tasks.result.items.search_partners:
                    type: boolean
                    description: >-
                      indicates data for Google and partner sites if true, the
                      results are returned for owned, operated, and syndicated
                      networks across Google and partner sites that host Google
                      search; if false, the results are returned for Google
                      search sites only
                  ...
                  tasks.result.items.serp_info.serp_item_types:
                    ...
                    description: >-
                      ...
                      results (items) found in SERP possible items types:
                  ...
                  tasks.result.items.avg_backlinks_info:
                    ...
                    description: >-
                      ...
                      top-10 websites ranking organically for the keyword
