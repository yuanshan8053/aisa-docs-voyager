...
````yaml openapi/dataforseo.json POST /dataforseo/serp/google/ads_advertisers/task_post
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/ads_advertisers/task_post:
    post:
      ...
      description: >-
        Setting Google Ads Advertisers SERP Tasks. Returns advertiser
        information from the Ads Transparency platform for the specified keyword
        and location. Your account is charged only for setting a task.
      operationId: post_dataforseo_serp_google_ads_advertisers_task_post
      requestBody:
        required: true
        content:
          application/json:
