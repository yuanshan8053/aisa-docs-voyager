...
````yaml openapi/dataforseo.json GET /dataforseo/ai_optimization/gemini/llm_scraper/languages
openapi: 3.0.3
info:
...
paths:
  /dataforseo/ai_optimization/gemini/llm_scraper/languages:
    get:
      ...
      description: Pricing
      operationId: get_dataforseo_ai_optimization_gemini_llm_scraper_languages
      responses:
        '200':
