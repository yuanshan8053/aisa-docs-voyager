...
````yaml openapi/dataforseo.json POST /dataforseo/serp/youtube/organic/live/advanced
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/youtube/organic/live/advanced:
    post:
      ...
      description: >-
        Live YouTube Organic Advanced. Returns YouTube Organic search results in
        real time. Each Live SERP API call can contain only one task.
      operationId: post_dataforseo_serp_youtube_organic_live_advanced
      requestBody:
        required: true
        content:
          application/json:
