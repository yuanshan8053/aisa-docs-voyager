...
````yaml openapi/dataforseo.json GET /dataforseo/keywords_data/bing/keyword_suggestions_for_url/languages
openapi: 3.0.3
info:
...
paths:
  /dataforseo/keywords_data/bing/keyword_suggestions_for_url/languages:
    get:
      ...
      description: Pricing
      operationId: get_dataforseo_keywords_data_bing_keyword_suggestions_for_url_languages
      responses:
        '200':
