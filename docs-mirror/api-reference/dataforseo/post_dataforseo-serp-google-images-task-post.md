...
````yaml openapi/dataforseo.json POST /dataforseo/serp/google/images/task_post
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/images/task_post:
    post:
      ...
      description: >-
        Setting Google Images SERP Tasks. Your account is charged only for
      ...
      operationId: post_dataforseo_serp_google_images_task_post
      requestBody:
        required: true
        content:
          application/json:
            schema:
              ...
              properties:
                ...
                postback_data:
                  type: string
                  description: >-
                    Postback datatype; possible values include regular,
                    advanced, html
              required:
                - keyword
      responses:
