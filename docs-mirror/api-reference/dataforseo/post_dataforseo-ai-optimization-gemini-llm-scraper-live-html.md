...
````yaml openapi/dataforseo.json POST /dataforseo/ai_optimization/gemini/llm_scraper/live/html
openapi: 3.0.3
info:
...
paths:
  /dataforseo/ai_optimization/gemini/llm_scraper/live/html:
    post:
      ...
      description: >-
        Live Gemini LLM Scraper API HTML provides a raw HTML page of the results
        for the specified keyword, language (see [the List of
        Languages](https://docs.dataforseo.com/v3/ai_optimization/gemini/llm_scraper/languages.md)),
        and location (see [the List of
        Locations](https://docs.dataforseo.com/v3/ai_optimization/gemini/llm_scraper/locations.md)).
      operationId: post_dataforseo_ai_optimization_gemini_llm_scraper_live_html
      requestBody:
        required: true
        content:
          application/json:
              ...
              properties:
                ...
                expand_citations:
                  ...
                  description: >-
                    ...
                    when enabled, the endpoint will return HTML data from the
