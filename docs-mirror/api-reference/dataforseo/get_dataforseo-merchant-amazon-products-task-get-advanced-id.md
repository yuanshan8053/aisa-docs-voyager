...
````yaml openapi/dataforseo.json GET /dataforseo/merchant/amazon/products/task_get/advanced/{id}
openapi: 3.0.3
info:
  ...
  /dataforseo/merchant/amazon/products/task_get/advanced/{id}:
    get:
      ...
      description: >-
        ...
        GET
        https://api.dataforseo.com/v3/merchant/amazon/products/task\_get/advanced/$id
      operationId: get_dataforseo_merchant_amazon_products_task_get_advanced_id
      responses:
        '200':
