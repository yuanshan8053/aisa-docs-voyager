...
````yaml openapi/dataforseo.json GET /dataforseo/serp/yahoo/organic/tasks_ready
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/yahoo/organic/tasks_ready:
    get:
      ...
      description: >-
        Get Organic SERP Completed Tasks. Returns completed Yahoo Organic SERP
        tasks that have not been collected yet.
      operationId: get_dataforseo_serp_yahoo_organic_tasks_ready
      responses:
        '200':
