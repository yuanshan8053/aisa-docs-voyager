...
````yaml openapi/dataforseo.json GET /dataforseo/serp/google/finance_explore/tasks_ready
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/finance_explore/tasks_ready:
    get:
      ...
      description: >-
        Get Finance Explore SERP Completed Tasks. Returns completed Google
        Finance Explore tasks that have not been collected yet.
      operationId: get_dataforseo_serp_google_finance_explore_tasks_ready
      responses:
        '200':
