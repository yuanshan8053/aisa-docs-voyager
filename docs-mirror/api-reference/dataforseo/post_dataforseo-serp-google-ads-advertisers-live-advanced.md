...
````yaml openapi/dataforseo.json POST /dataforseo/serp/google/ads_advertisers/live/advanced
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/ads_advertisers/live/advanced:
    post:
      ...
      description: >-
        Live Google Ads Advertisers Advanced. Returns advertiser information
        from Google Ads in real time. Each Live SERP API call can contain only
        one task.
      operationId: post_dataforseo_serp_google_ads_advertisers_live_advanced
      requestBody:
        required: true
        content:
          application/json:
