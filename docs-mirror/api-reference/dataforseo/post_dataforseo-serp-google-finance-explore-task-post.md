...
````yaml openapi/dataforseo.json POST /dataforseo/serp/google/finance_explore/task_post
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/finance_explore/task_post:
    post:
      ...
      description: >-
        Setting Google Finance Explore SERP Tasks. Provides real-time data from
        the Explore tab of Google Finance for the specified location and
        language.
      operationId: post_dataforseo_serp_google_finance_explore_task_post
      requestBody:
        required: false
        content:
          application/json:
