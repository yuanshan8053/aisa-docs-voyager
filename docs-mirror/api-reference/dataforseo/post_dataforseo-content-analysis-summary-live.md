...
````yaml openapi/dataforseo.json POST /dataforseo/content_analysis/summary/live
openapi: 3.0.3
info:
...
paths:
  /dataforseo/content_analysis/summary/live:
    post:
      ...
      description: >-
        This endpoint will provide you with an overview of citation data
        available for the target keyword.
      operationId: post_dataforseo_content_analysis_summary_live
      requestBody:
        required: true
        content:
          application/json:
              ...
              properties:
                ...
                initial_dataset_filters:
                  ...
                  description: >-
                    ...
                    has_not you can use the % operator with like and not_like to
                    match any string of zero or more characters example:
                    ["domain","", "logitech.com"]
                ...
                properties:
                  ...
                  tasks.result.rank:
                    ...
                    description: >-
                      ...
                      ranks of all URLs citing the target keyword
                  tasks.result.top_domains:
                    ...
                    description: >-
                      ...
                      with top domains citing the target keword and citation
                  ...
                  tasks.result.sentiment_connotations:
                    ...
                    description: >-
                      ...
                      number of citations per each sentiment possible sentiment
                      connotations: anger, happiness, love, sadness, share, fun
                  tasks.result.connotation_types:
                    ...
                    description: >-
                      ...
                      count per each sentiment type possible sentiment
