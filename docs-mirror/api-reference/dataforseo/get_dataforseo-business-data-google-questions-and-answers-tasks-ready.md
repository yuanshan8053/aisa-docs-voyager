...
````yaml openapi/dataforseo.json GET /dataforseo/business_data/google/questions_and_answers/tasks_ready
openapi: 3.0.3
info:
  ...
  /dataforseo/business_data/google/questions_and_answers/tasks_ready:
    get:
      ...
      description: >-
        ...
        **‘Task GET’** endpoint.
      operationId: get_dataforseo_business_data_google_questions_and_answers_tasks_ready
      responses:
        '200':
