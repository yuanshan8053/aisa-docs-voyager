...
````yaml openapi/dataforseo.json GET /dataforseo/serp/seznam/locations
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/seznam/locations:
    get:
      ...
      description: >-
        List of Seznam Locations for SERP. Returns the list of supported
        locations for Seznam SERP. Your account is not charged for using this
        endpoint.
