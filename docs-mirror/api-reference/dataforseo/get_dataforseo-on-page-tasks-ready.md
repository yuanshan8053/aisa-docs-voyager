...
````yaml openapi/dataforseo.json GET /dataforseo/on_page/tasks_ready
openapi: 3.0.3
info:
...
paths:
  /dataforseo/on_page/tasks_ready:
    get:
      ...
      description: >-
        The ‘Tasks Ready’ endpoint is designed to provide you with a list of
        completed tasks, which results haven’t been collected yet.
      operationId: get_dataforseo_on_page_tasks_ready
      responses:
        '200':
