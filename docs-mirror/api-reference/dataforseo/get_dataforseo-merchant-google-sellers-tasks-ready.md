...
````yaml openapi/dataforseo.json GET /dataforseo/merchant/google/sellers/tasks_ready
openapi: 3.0.3
info:
...
paths:
  /dataforseo/merchant/google/sellers/tasks_ready:
    get:
      ...
      operationId: get_dataforseo_merchant_google_sellers_tasks_ready
      responses:
        '200':
              ...
              schema:
                ...
                properties:
                  ...
                  tasks.result.endpoint_advanced:
                    type: string
                    description: >-
                      URL for collecting the results of Google Shopping Sellers
                      Advanced task
