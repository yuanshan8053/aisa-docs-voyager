...
````yaml openapi/dataforseo.json POST /dataforseo/serp/baidu/organic/task_post
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/baidu/organic/task_post:
    post:
      ...
      description: >-
        Setting Baidu Organic SERP Tasks. Your account is charged only for
      ...
      operationId: post_dataforseo_serp_baidu_organic_task_post
      requestBody:
        required: true
        content:
          application/json:
