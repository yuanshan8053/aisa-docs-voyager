...
````yaml openapi/dataforseo.json GET /dataforseo/serp/google/finance_ticker_search/task_get/advanced/{id}
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/finance_ticker_search/task_get/advanced/{id}:
    get:
      ...
      description: >-
        Get Google Finance Ticker Search Results by id. Returns advanced ticker
        search results for a previously posted task.
      operationId: get_dataforseo_serp_google_finance_ticker_search_task_get_advanced_id
      parameters:
        - name: id
          in: path
          required: true
