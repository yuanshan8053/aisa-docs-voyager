...
````yaml openapi/dataforseo.json GET /dataforseo/serp/google/dataset_info/tasks_ready
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/dataset_info/tasks_ready:
    get:
      ...
      description: >-
        Get Dataset Info SERP Completed Tasks. Returns completed Google Dataset
        Info tasks that have not been collected yet.
      operationId: get_dataforseo_serp_google_dataset_info_tasks_ready
      responses:
        '200':
