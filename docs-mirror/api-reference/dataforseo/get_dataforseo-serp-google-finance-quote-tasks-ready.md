...
````yaml openapi/dataforseo.json GET /dataforseo/serp/google/finance_quote/tasks_ready
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/finance_quote/tasks_ready:
    get:
      ...
      description: >-
        Get Finance Quote SERP Completed Tasks. Returns completed Google Finance
        Quote tasks that have not been collected yet.
      operationId: get_dataforseo_serp_google_finance_quote_tasks_ready
      responses:
        '200':
