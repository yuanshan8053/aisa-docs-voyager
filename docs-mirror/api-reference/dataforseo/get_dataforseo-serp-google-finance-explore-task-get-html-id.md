...
````yaml openapi/dataforseo.json GET /dataforseo/serp/google/finance_explore/task_get/html/{id}
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/finance_explore/task_get/html/{id}:
    get:
      ...
      description: >-
        Get Google Finance Explore HTML Results by id. Returns HTML results for
        a previously posted task.
      operationId: get_dataforseo_serp_google_finance_explore_task_get_html_id
      parameters:
        - name: id
          in: path
          required: true
