...
````yaml openapi/dataforseo.json GET /dataforseo/serp/yahoo/locations
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/yahoo/locations:
    get:
      ...
      description: >-
        List of Yahoo Locations for SERP. Returns the list of supported
        locations for Yahoo SERP. Your account is not charged for using this
        endpoint.
