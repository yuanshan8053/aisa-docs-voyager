...
````yaml openapi/dataforseo.json GET /dataforseo/serp/bing/organic/task_get/html/{id}
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/bing/organic/task_get/html/{id}:
    get:
      ...
      description: >-
        Get Bing Organic HTML Results by id. Returns HTML results for a
        previously posted Bing Organic task.
      operationId: get_dataforseo_serp_bing_organic_task_get_html_id
      parameters:
        - name: id
          in: path
          required: true
