...
````yaml openapi/dataforseo.json GET /dataforseo/serp/bing/organic/tasks_ready
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/bing/organic/tasks_ready:
    get:
      ...
      description: >-
        Get Organic SERP Completed Tasks. Returns completed Bing Organic SERP
        tasks that have not been collected yet.
      operationId: get_dataforseo_serp_bing_organic_tasks_ready
      responses:
        '200':
