...
````yaml openapi/dataforseo.json GET /dataforseo/merchant/amazon/sellers/task_get/html/{id}
openapi: 3.0.3
info:
  ...
  /dataforseo/merchant/amazon/sellers/task_get/html/{id}:
    get:
      ...
      description: >-
        ...
        GET
        https://api.dataforseo.com/v3/merchant/amazon/sellers/task\_get/html/$id
      operationId: get_dataforseo_merchant_amazon_sellers_task_get_html_id
      responses:
        '200':
