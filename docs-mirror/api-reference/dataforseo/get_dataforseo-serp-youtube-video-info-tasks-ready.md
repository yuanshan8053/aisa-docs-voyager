...
````yaml openapi/dataforseo.json GET /dataforseo/serp/youtube/video_info/tasks_ready
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/youtube/video_info/tasks_ready:
    get:
      ...
      description: >-
        Get Video Info SERP Completed Tasks. Returns completed YouTube Video
        Info tasks that have not been collected yet.
      operationId: get_dataforseo_serp_youtube_video_info_tasks_ready
      responses:
        '200':
