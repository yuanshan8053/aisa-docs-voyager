...
````yaml openapi/dataforseo.json GET /dataforseo/app_data/google/app_searches/task_get/html/{id}
openapi: 3.0.3
info:
  ...
  /dataforseo/app_data/google/app_searches/task_get/html/{id}:
    get:
      ...
      description: >-
        ...
        GET
        https://api.dataforseo.com/v3/app\_data/google/app\_searches/task\_get/html/$id
      operationId: get_dataforseo_app_data_google_app_searches_task_get_html_id
      responses:
        '200':
