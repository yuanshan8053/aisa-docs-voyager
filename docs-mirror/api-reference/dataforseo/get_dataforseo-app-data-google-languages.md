...
````yaml openapi/dataforseo.json GET /dataforseo/app_data/google/languages
openapi: 3.0.3
info:
...
paths:
  /dataforseo/app_data/google/languages:
    get:
      ...
      description: >-
        By calling this endpoint you will receive the list of Google languages
        supported in App Data API.
      operationId: get_dataforseo_app_data_google_languages
      responses:
        '200':
