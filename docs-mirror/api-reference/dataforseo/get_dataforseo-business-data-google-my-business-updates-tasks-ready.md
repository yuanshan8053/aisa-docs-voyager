...
````yaml openapi/dataforseo.json GET /dataforseo/business_data/google/my_business_updates/tasks_ready
openapi: 3.0.3
info:
  ...
  /dataforseo/business_data/google/my_business_updates/tasks_ready:
    get:
      ...
      description: >-
        ...
        **‘Task GET’** endpoint.
      operationId: get_dataforseo_business_data_google_my_business_updates_tasks_ready
      responses:
        '200':
