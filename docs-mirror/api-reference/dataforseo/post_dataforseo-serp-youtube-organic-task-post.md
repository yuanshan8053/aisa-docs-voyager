...
````yaml openapi/dataforseo.json POST /dataforseo/serp/youtube/organic/task_post
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/youtube/organic/task_post:
    post:
      ...
      description: >-
        Setting YouTube Organic Tasks. Returns organic YouTube search results
        for the specified keyword. Your account is charged only for setting a
        task.
      operationId: post_dataforseo_serp_youtube_organic_task_post
      requestBody:
        required: true
        content:
          application/json:
