...
````yaml openapi/dataforseo.json GET /dataforseo/app_data/google/app_info/task_get/advanced/{id}
openapi: 3.0.3
info:
  ...
  /dataforseo/app_data/google/app_info/task_get/advanced/{id}:
    get:
      ...
      description: >-
        ...
        description, reviews count, rating, number of installs, images, and
        other data. The results are specific to the `app_id` parameter specified
        in the POST request.
      operationId: get_dataforseo_app_data_google_app_info_task_get_advanced_id
      responses:
        '200':
