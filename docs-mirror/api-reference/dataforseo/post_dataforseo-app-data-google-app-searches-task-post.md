...
````yaml openapi/dataforseo.json POST /dataforseo/app_data/google/app_searches/task_post
openapi: 3.0.3
info:
  ...
  /dataforseo/app_data/google/app_searches/task_post:
    post:
      ...
      description: >-
        ...
        Play for the specified `keyword`. The returned results are specific to
        the indicated keyword, as well as the
        ...
        parameters.
      operationId: post_dataforseo_app_data_google_app_searches_task_post
      requestBody:
        required: true
        content:
          application/json:
            schema:
              ...
              properties:
                ...
                language_name:
                  type: string
                  description: >-
                    full name of search engine language optional field if you
                    use this field, you don’t need to specify language_code you
                    can receive the list of available languages with
                ...
                language_code:
                  type: string
                  description: >-
                    search engine language code optional field if you use this
                    field, you don’t need to specify language_name you can
                ...
                depth:
                  ...
                  description: >-
                    ...
                    returned to be returned from the Google Play SERP; we
                    strongly recommend setting the parsing depth in the
                    multiples of 30, because our system processes 30 results in
                    a row; default value: 30; maximum value: 200; Your account
