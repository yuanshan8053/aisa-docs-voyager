...
````yaml openapi/dataforseo.json GET /dataforseo/app_data/google/app_info/task_get/html/{id}
openapi: 3.0.3
info:
  ...
  /dataforseo/app_data/google/app_info/task_get/html/{id}:
    get:
      ...
      description: >-
        ...
        GET
        https://api.dataforseo.com/v3/app\_data/google/app\_info/task\_get/html/$id
      operationId: get_dataforseo_app_data_google_app_info_task_get_html_id
      responses:
        '200':
