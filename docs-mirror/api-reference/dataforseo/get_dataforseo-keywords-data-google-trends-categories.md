...
````yaml openapi/dataforseo.json GET /dataforseo/keywords_data/google_trends/categories
openapi: 3.0.3
info:
...
paths:
  /dataforseo/keywords_data/google_trends/categories:
    get:
      ...
      description: Pricing
      operationId: get_dataforseo_keywords_data_google_trends_categories
      responses:
        '200':
                ...
                properties:
                  ...
                  tasks.result.category_code_parent:
                    ...
                    description: >-
                      ...
                      "category_code": 1100, "category_name": "Superhero Films",
                      "category_code_parent": 1097 where category_code_parent
                      corresponds to: "category_code": 1097, "category_name":
