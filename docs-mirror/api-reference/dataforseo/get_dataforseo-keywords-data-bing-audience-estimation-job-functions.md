...
````yaml openapi/dataforseo.json GET /dataforseo/keywords_data/bing/audience_estimation/job_functions
openapi: 3.0.3
info:
...
paths:
  /dataforseo/keywords_data/bing/audience_estimation/job_functions:
    get:
      ...
      description: Pricing
      operationId: get_dataforseo_keywords_data_bing_audience_estimation_job_functions
      responses:
        '200':
