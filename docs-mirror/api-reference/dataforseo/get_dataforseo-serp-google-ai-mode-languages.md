...
````yaml openapi/dataforseo.json GET /dataforseo/serp/google/ai_mode/languages
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/ai_mode/languages:
    get:
      ...
      description: >-
        You will receive the list of languages by calling this API. Your account
        will not be charged for using this API.
