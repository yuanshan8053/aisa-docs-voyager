...
````yaml openapi/dataforseo.json GET /dataforseo/serp/naver/organic/task_get/advanced/{id}
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/naver/organic/task_get/advanced/{id}:
    get:
      ...
      description: >-
        Get Naver Organic SERP Advanced Results by id. Returns advanced SERP
        results for a previously posted Naver Organic task.
      operationId: get_dataforseo_serp_naver_organic_task_get_advanced_id
      parameters:
        - name: id
          in: path
          required: true
