...
````yaml openapi/dataforseo.json GET /dataforseo/business_data/google/hotel_searches/tasks_ready
openapi: 3.0.3
info:
  ...
  /dataforseo/business_data/google/hotel_searches/tasks_ready:
    get:
      ...
      description: >-
        ...
        **‘Task GET’** endpoint.
      operationId: get_dataforseo_business_data_google_hotel_searches_tasks_ready
      responses:
        '200':
