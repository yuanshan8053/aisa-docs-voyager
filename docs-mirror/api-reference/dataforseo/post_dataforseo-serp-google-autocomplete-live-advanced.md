...
````yaml openapi/dataforseo.json POST /dataforseo/serp/google/autocomplete/live/advanced
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/autocomplete/live/advanced:
    post:
      ...
      description: >-
        Live Google Autocomplete Advanced. Returns Google Autocomplete
        suggestions in real time. Each Live SERP API call can contain only one
        task.
      operationId: post_dataforseo_serp_google_autocomplete_live_advanced
      requestBody:
        required: true
        content:
          application/json:
