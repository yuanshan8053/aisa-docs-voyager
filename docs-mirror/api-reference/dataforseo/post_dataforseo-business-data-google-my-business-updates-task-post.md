...
````yaml openapi/dataforseo.json POST /dataforseo/business_data/google/my_business_updates/task_post
openapi: 3.0.3
info:
...
paths:
  /dataforseo/business_data/google/my_business_updates/task_post:
    post:
      ...
      description: >-
        This endpoints provides the latest updates of a specific business entity
        from Google SERP. The provided results are specific to the selected
        ...
        settings.
      operationId: post_dataforseo_business_data_google_my_business_updates_task_post
      requestBody:
        required: true
        content:
          application/json:
            schema:
              ...
              properties:
                keyword:
                  ...
                  description: >-
                    ...
                    **up to 700 characters** in the `keyword` filed **all %##
                    ...
                    also be used to pass `cid` (unique, google-defined id of the
                    business entity) or `place_id` (identifier of the business
                    entity in Google Maps) parameters example:
                    `cid:194604053573767737`
                    `place_id:GhIJQWDl0CIeQUARxks3icF8U8A`learn more about the
                    `cid` and `place_id` identifiers in [this help center
                ...
                priority:
                  ...
                  description: >-
                    *task priority* optional field can take the following
                    ...
                    calculated on the
                    [Pricing](https://dataforseo.com/pricing/business-data/business-data-api
                    "Pricing") page.
                location_name:
                  type: string
                  description: >-
                ...
                depth:
                  type: integer
                  description: >-
                    *parsing depth* optional field number of updates in SERP we
                    strongly recommend setting the parsing depth in the
                    multiples of ten, because our systems processes ten updates
                    in a row **please note that Google returns 4490 updates
                    maximum** default value: `10`
                tag:
                  type: string
                  description: >-
