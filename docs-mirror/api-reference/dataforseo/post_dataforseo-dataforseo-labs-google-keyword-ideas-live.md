...
````yaml openapi/dataforseo.json POST /dataforseo/dataforseo_labs/google/keyword_ideas/live
openapi: 3.0.3
info:
...
paths:
  /dataforseo/dataforseo_labs/google/keyword_ideas/live:
    post:
      ...
      description: >-
        The Keyword Ideas endpoint provides search terms that are relevant to
        the product or service categories of the specified keywords. The
        algorithm selects the keywords which fall into the same categories as
        the seed keywords specified in a POST array.
      operationId: post_dataforseo_dataforseo_labs_google_keyword_ideas_live
      requestBody:
        required: true
        content:
          application/json:
              ...
              properties:
                keywords:
                  ...
                  description: >-
                    ...
                    keywords you can specify: 200. The keywords will be
                ...
                language_name:
                  ...
                  description: >-
                    ...
                    https://api.dataforseo.com/v3/dataforseo_labs/locations_and_languages
                    example: English Note: if omitted, results default to the
                    language with the most keyword records in the specified
                    location; refer to the available_languages.keywords field of
                    the Locations and Languages endpoint to determine the
                    default language
                language_code:
                  type: string
                  description: >-
                    ...
                    separate request to the
                    https://api.dataforseo.com/v3/dataforseo_labs/locations_and_languages
                    example: en Note: if omitted, results default to the
                    language with the most keyword records in the specified
                    location; refer to the available_languages.keywords field of
                    the Locations and Languages endpoint to determine the
                    default language
                closely_variants:
                  type: boolean
                  description: >-
                    search mode optional field if set to true the results will
                    be based on the phrase-match search algorithm if set to
                    false the results will be based on the broad-match search
                ...
                limit:
                  ...
                  description: >-
                    ...
                    field default value: 700 maximum value: 1000
                offset:
                  type: integer
                  description: >-
                ...
                filters:
                  ...
                  description: >-
                    ...
                    zero or more characters note that you can not filter the
                    results by relevance example:
                ...
                order_by:
                  ...
                  description: >-
                    ...
                    you should use a comma to set up a sorting parameter default
                    rule: ["relevance,desc"] relevance is used as the default
                    sorting rule to provide you with the closest keyword ideas.
                    We recommend using this sorting rule to get highly-relevant
                    search terms. Note that relevance is only our internal
                    system identifier, so it can not be used as a filter, and
                    you will not find this field in the result array. The
                    relevance score is based on a similar principle as used in
                    the Keywords For Keywords endpoint. note that you can set no
                ...
                properties:
                  ...
                  tasks.result.seed_keywords:
                    ...
                    items:
                      type: string
                    description: >-
                      keywords in a POST array keywords are returned with
                  ...
                  tasks.result.total_count:
                    type: integer
                    description: >-
                      total number of results relevant to your request in our
                      database
