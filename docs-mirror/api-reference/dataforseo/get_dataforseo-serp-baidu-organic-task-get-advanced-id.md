...
````yaml openapi/dataforseo.json GET /dataforseo/serp/baidu/organic/task_get/advanced/{id}
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/baidu/organic/task_get/advanced/{id}:
    get:
      ...
      description: >-
        Get Baidu Organic SERP Advanced Results by id. Returns advanced SERP
        results for a previously posted Baidu Organic task.
      operationId: get_dataforseo_serp_baidu_organic_task_get_advanced_id
      parameters:
        - name: id
          in: path
          required: true
