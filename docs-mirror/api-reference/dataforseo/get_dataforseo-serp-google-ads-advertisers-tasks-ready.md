...
````yaml openapi/dataforseo.json GET /dataforseo/serp/google/ads_advertisers/tasks_ready
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/ads_advertisers/tasks_ready:
    get:
      ...
      description: >-
        Get Ads Advertisers SERP Completed Tasks. Returns completed Google Ads
        Advertisers tasks that have not been collected yet.
      operationId: get_dataforseo_serp_google_ads_advertisers_tasks_ready
      responses:
        '200':
