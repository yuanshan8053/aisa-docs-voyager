...
````yaml openapi/dataforseo.json POST /dataforseo/app_data/apple/app_reviews/task_post
openapi: 3.0.3
info:
...
paths:
  /dataforseo/app_data/apple/app_reviews/task_post:
    post:
      ...
      description: >-
        This endpoint will provide you with reviews published on the App Store
        platform for the app specified in the `app_id` field. The returned
        results are specific to the indicated
        ...
        parameters.
      operationId: post_dataforseo_app_data_apple_app_reviews_task_post
      requestBody:
        required: true
        content:
          application/json:
              ...
              properties:
                ...
                depth:
                  ...
                  description: >-
                    ...
                    the parsing depth in the multiples of 50, because our system
                    processes 50 reviews in a row; default value: 50; maximum
                    value: 500; Your account will be billed per each SERP
                    containing up to 50 results; Setting depth above 50 may
                    result in additional charges if the search engine returns
                    more than 50 results; The cost can be calculated on the
                    Pricing page.
                sort_by:
                  type: string
                  description: >-
                    ...
                    most_recent — sort by the most recent reviews; most_helpful
                    — sort by the most relevant reviews; default rule:
                    most_helpful
                tag:
                  type: string
                  description: >-
