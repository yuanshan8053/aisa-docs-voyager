...
````yaml openapi/dataforseo.json POST /dataforseo/serp/google/events/live/advanced
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/events/live/advanced:
    post:
      ...
      description: >-
        Live Google Events SERP Advanced. Returns Google Events SERP results in
        real time. Each Live SERP API call can contain only one task.
      operationId: post_dataforseo_serp_google_events_live_advanced
      requestBody:
        required: true
        content:
          application/json:
