...
````yaml openapi/dataforseo.json GET /dataforseo/business_data/trustpilot/search/tasks_ready
openapi: 3.0.3
info:
  ...
  /dataforseo/business_data/trustpilot/search/tasks_ready:
    get:
      ...
      description: >-
        ...
        **‘Task GET’** endpoint.
      operationId: get_dataforseo_business_data_trustpilot_search_tasks_ready
      responses:
        '200':
