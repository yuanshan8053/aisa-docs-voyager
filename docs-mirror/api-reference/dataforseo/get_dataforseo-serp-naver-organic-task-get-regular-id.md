...
````yaml openapi/dataforseo.json GET /dataforseo/serp/naver/organic/task_get/regular/{id}
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/naver/organic/task_get/regular/{id}:
    get:
      ...
      description: >-
        Get Naver Organic SERP Results by id (regular). Returns regular SERP
        results for a previously posted Naver Organic task.
      operationId: get_dataforseo_serp_naver_organic_task_get_regular_id
      parameters:
        - name: id
          in: path
          required: true
