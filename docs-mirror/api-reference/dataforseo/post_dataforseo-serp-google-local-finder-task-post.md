...
````yaml openapi/dataforseo.json POST /dataforseo/serp/google/local_finder/task_post
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/local_finder/task_post:
    post:
      ...
      description: >-
        Setting Google Local Finder SERP Tasks. Your account is charged only for
      ...
      operationId: post_dataforseo_serp_google_local_finder_task_post
      requestBody:
        required: true
        content:
          application/json:
