...
````yaml openapi/dataforseo.json GET /dataforseo/serp/google/events/locations
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/events/locations:
    get:
      ...
      description: >-
        List of Google Events Locations for SERP API. Returns the list of
        supported locations for Google Events SERP. Your account is not charged
        for using this endpoint.
