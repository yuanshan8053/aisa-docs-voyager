...
````yaml openapi/dataforseo.json POST /dataforseo/serp/youtube/video_subtitles/task_post
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/youtube/video_subtitles/task_post:
    post:
      ...
      description: >-
        Setting YouTube Subtitles Tasks. Returns subtitles for a specified
        YouTube video. Your account is charged only for setting a task.
      operationId: post_dataforseo_serp_youtube_video_subtitles_task_post
      requestBody:
        required: true
        content:
          application/json:
