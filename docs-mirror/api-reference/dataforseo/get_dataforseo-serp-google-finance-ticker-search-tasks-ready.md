...
````yaml openapi/dataforseo.json GET /dataforseo/serp/google/finance_ticker_search/tasks_ready
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/finance_ticker_search/tasks_ready:
    get:
      ...
      description: >-
        Get Finance Ticker Search SERP Completed Tasks. Returns completed Google
        Finance Ticker Search tasks that have not been collected yet.
      operationId: get_dataforseo_serp_google_finance_ticker_search_tasks_ready
      responses:
        '200':
