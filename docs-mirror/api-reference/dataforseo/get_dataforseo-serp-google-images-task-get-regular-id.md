...
````yaml openapi/dataforseo.json GET /dataforseo/serp/google/images/task_get/regular/{id}
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/images/task_get/regular/{id}:
    get:
      ...
      description: >-
        Get Google Images SERP Results by id. Returns regular image SERP results
        for a previously posted task.
      operationId: get_dataforseo_serp_google_images_task_get_regular_id
      parameters:
        - name: id
          in: path
          required: true
