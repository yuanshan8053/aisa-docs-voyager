...
````yaml openapi/dataforseo.json GET /dataforseo/merchant/amazon/sellers/tasks_ready
openapi: 3.0.3
info:
...
paths:
  /dataforseo/merchant/amazon/sellers/tasks_ready:
    get:
      ...
      operationId: get_dataforseo_merchant_amazon_sellers_tasks_ready
      responses:
        '200':
              ...
              schema:
                ...
                properties:
                  ...
                  tasks.result.endpoint_advanced:
                    type: string
                    description: >-
                      URL for collecting the results of Amazon Sellers Advanced
                      task
