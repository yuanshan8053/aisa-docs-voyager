...
````yaml openapi/dataforseo.json POST /dataforseo/serp/google/maps/task_post
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/maps/task_post:
    post:
      ...
      description: >-
        Setting Google Maps SERP Tasks. Your account is charged only for setting
      ...
      operationId: post_dataforseo_serp_google_maps_task_post
      requestBody:
        required: true
        content:
          application/json:
