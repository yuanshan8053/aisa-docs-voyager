...
````yaml openapi/dataforseo.json GET /dataforseo/serp/youtube/video_info/task_get/advanced/{id}
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/youtube/video_info/task_get/advanced/{id}:
    get:
      ...
      description: >-
        Get YouTube Video Info Results by id. Returns advanced video info
        results for a previously posted task.
      operationId: get_dataforseo_serp_youtube_video_info_task_get_advanced_id
      parameters:
        - name: id
          in: path
          required: true
