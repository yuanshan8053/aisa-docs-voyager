...
````yaml openapi/dataforseo.json POST /dataforseo/serp/google/finance_quote/live/advanced
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/finance_quote/live/advanced:
    post:
      ...
      description: >-
        Live Google Finance Quote Advanced. Returns Google Finance Quote results
        in real time. Each Live SERP API call can contain only one task.
      operationId: post_dataforseo_serp_google_finance_quote_live_advanced
      requestBody:
        required: true
        content:
          application/json:
