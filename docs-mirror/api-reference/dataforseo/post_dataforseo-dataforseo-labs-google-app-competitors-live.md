...
````yaml openapi/dataforseo.json POST /dataforseo/dataforseo_labs/google/app_competitors/live
openapi: 3.0.3
info:
  ...
  /dataforseo/dataforseo_labs/google/app_competitors/live:
    post:
      ...
      description: >-
        ...
        intersect with the target app for its ranking keywords on Google Play.
        You will obtain the IDs of competitor apps along with search volume and
        ranking data on competitor ranking keywords.
      operationId: post_dataforseo_dataforseo_labs_google_app_competitors_live
      requestBody:
        required: true
        content:
          application/json:
              ...
              properties:
                app_id:
                  ...
                  description: >-
                    ...
                    listed on Google Play; example: in the URL
              ...
              schema:
                ...
                properties:
                  ...
                  tasks.result.items.avg_position:
                    type: number
                    description: >-
                      average position of the app in Google Play SERP Note:
                  ...
                  tasks.result.items.sum_position:
                    type: integer
                    description: >-
                      sum of all app positions in Google Play SERP Note: sum
                  ...
                  tasks.result.items.competitor_metrics.google_play_search_organic.search_volume:
                    type: integer
                    description: >-
                      total search volume of the intersecting keywords in Google
                      Play organic SERP
                  ...
                  tasks.result.items.full_metrics.google_play_search_organic.search_volume:
                    type: integer
                    description: >-
                      total search volume of the app’s ranking keywords in
                      Google Play organic SERP
        '400':
