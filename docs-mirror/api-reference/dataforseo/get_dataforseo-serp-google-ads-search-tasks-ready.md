...
````yaml openapi/dataforseo.json GET /dataforseo/serp/google/ads_search/tasks_ready
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/ads_search/tasks_ready:
    get:
      ...
      description: >-
        Get Ads Search SERP Completed Tasks. Returns completed Google Ads Search
        tasks that have not been collected yet.
      operationId: get_dataforseo_serp_google_ads_search_tasks_ready
      responses:
        '200':
