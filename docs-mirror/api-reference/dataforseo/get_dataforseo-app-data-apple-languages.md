...
````yaml openapi/dataforseo.json GET /dataforseo/app_data/apple/languages
openapi: 3.0.3
info:
...
paths:
  /dataforseo/app_data/apple/languages:
    get:
      ...
      description: >-
        By calling this endpoint you will receive the list of Apple languages
        supported in App Data API.
      operationId: get_dataforseo_app_data_apple_languages
      responses:
        '200':
