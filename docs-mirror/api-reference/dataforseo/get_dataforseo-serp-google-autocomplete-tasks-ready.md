...
````yaml openapi/dataforseo.json GET /dataforseo/serp/google/autocomplete/tasks_ready
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/autocomplete/tasks_ready:
    get:
      ...
      description: >-
        Get Autocomplete SERP Completed Tasks. Returns completed Google
        Autocomplete tasks that have not been collected yet.
      operationId: get_dataforseo_serp_google_autocomplete_tasks_ready
      responses:
        '200':
