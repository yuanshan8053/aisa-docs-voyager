...
````yaml openapi/dataforseo.json GET /dataforseo/ai_optimization/gemini/llm_scraper/task_get/html/{id}
openapi: 3.0.3
info:
  ...
  /dataforseo/ai_optimization/gemini/llm_scraper/task_get/html/{id}:
    get:
      ...
      description: >-
        ...
        GET
        https://api.dataforseo.com/v3/ai\_optimization/gemini/llm\_scraper/task\_get/html/$id
      operationId: get_dataforseo_ai_optimization_gemini_llm_scraper_task_get_html_id
      responses:
        '200':
