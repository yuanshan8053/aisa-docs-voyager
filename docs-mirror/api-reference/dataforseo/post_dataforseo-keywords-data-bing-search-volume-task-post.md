...
````yaml openapi/dataforseo.json POST /dataforseo/keywords_data/bing/search_volume/task_post
openapi: 3.0.3
info:
...
paths:
  /dataforseo/keywords_data/bing/search_volume/task_post:
    post:
      ...
      operationId: post_dataforseo_keywords_data_bing_search_volume_task_post
      requestBody:
        required: true
        content:
          application/json:
              ...
              properties:
                ...
                date_from:
                  ...
                  description: >-
                    ...
                    months minimal value: 24 months from today’s date date
                    format: "yyyy-mm-dd" example: "2020-01-01" Note: we do not
