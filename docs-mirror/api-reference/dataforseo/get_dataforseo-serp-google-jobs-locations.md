...
````yaml openapi/dataforseo.json GET /dataforseo/serp/google/jobs/locations
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/jobs/locations:
    get:
      ...
      description: >-
        List of Google Jobs Locations for SERP API. Returns the list of
        supported locations for Google Jobs SERP. Your account is not charged
