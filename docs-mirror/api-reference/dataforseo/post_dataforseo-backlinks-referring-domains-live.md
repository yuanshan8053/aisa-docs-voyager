...
````yaml openapi/dataforseo.json POST /dataforseo/backlinks/referring_domains/live
openapi: 3.0.3
info:
...
paths:
  /dataforseo/backlinks/referring_domains/live:
    post:
      ...
      description: >-
        This endpoint will provide you with a detailed overview of referring
        domains pointing to the target you specify.
              ...
              properties:
                ...
                filters:
                  ...
                  description: >-
                    ...
                    in, not_in, like, not_like, match, not_match you can use the
                    % operator with like and not_like to match any string of
                    zero or more characters example: ["referring_pages",">","1"]
                    [["referring_pages",">","2"], "and", ["backlinks",">","10"]]
                ...
                exclude_internal_backlinks:
                  ...
                  description: >-
                    ...
                    backlinks from subdomains of the target will be ommited and
              ...
              schema:
                ...
                properties:
                  ...
                  tasks.result.total_count:
                    type: integer
                    description: >-
                      total number of relevant items in the database total
                      number of main domains referring to your target;
                      example.com and blog.example.com are counted as one
                      referring domain
                  ...
                  tasks.result.items.rank:
                    type: integer
                    description: >-
                      domain rank rank volume that a referring website passes to
                      the target rank is calculated based on the method for node
                  ...
                  tasks.result.items.lost_date:
                    type: string
                    description: >-
                      date and time when the last backlink from this domain was
                  ...
                  tasks.result.items.referring_domains:
                    type: integer
                    description: >-
                      indicates the number of referring domains note that we
                      calculate main domains (root domains, like example.com)
                      and their subdomains (e.g. blog.example.com) separately
                      for this metric
                  ...
                  tasks.result.items.referring_main_domains:
                    type: integer
                    description: >-
                      indicates the number of referring main domains the number
                      of primary (root) domains referring to your target
                  ...
                  tasks.result.items.referring_links_semantic_locations:
                    ...
                    description: >-
                      ...
                      can get the full list of semantic elements here examples:
