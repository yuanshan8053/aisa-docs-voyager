...
````yaml openapi/dataforseo.json GET /dataforseo/serp/naver/organic/tasks_ready
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/naver/organic/tasks_ready:
    get:
      ...
      description: >-
        Get Organic SERP Completed Tasks. Returns completed Naver Organic SERP
        tasks that have not been collected yet.
      operationId: get_dataforseo_serp_naver_organic_tasks_ready
      responses:
        '200':
