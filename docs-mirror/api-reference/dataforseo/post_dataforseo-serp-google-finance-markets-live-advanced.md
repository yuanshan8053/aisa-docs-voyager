...
````yaml openapi/dataforseo.json POST /dataforseo/serp/google/finance_markets/live/advanced
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/finance_markets/live/advanced:
    post:
      ...
      description: >-
        Live Google Finance Markets Advanced. Returns Google Finance Markets
        results in real time. Each Live SERP API call can contain only one task.
      operationId: post_dataforseo_serp_google_finance_markets_live_advanced
      requestBody:
        required: true
        content:
          application/json:
