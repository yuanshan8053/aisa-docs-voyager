...
> This endpoint will provide you with a list of apps ranking on the App Store for the `keyword` specified in a POST request.



## OpenAPI

````yaml openapi/dataforseo.json GET /dataforseo/app_data/apple/app_searches/task_get/advanced/{id}
openapi: 3.0.3
info:
  ...
  /dataforseo/app_data/apple/app_searches/task_get/advanced/{id}:
    get:
      ...
      description: >-
        ...
        Store for the `keyword` specified in a POST request. You will also
        ...
        in the POST request.
      operationId: get_dataforseo_app_data_apple_app_searches_task_get_advanced_id
      responses:
        '200':
