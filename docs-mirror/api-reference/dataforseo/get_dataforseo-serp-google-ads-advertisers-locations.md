...
````yaml openapi/dataforseo.json GET /dataforseo/serp/google/ads_advertisers/locations
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/ads_advertisers/locations:
    get:
      ...
      description: >-
        List of Google Ads Advertisers Locations for SERP API. Returns supported
        locations. Your account is not charged for using this API.
      operationId: get_dataforseo_serp_google_ads_advertisers_locations
      responses:
        '200':
