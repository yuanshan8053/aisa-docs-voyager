...
````yaml openapi/dataforseo.json POST /dataforseo/keywords_data/google_ads/keywords_for_keywords/task_post
openapi: 3.0.3
info:
...
paths:
  /dataforseo/keywords_data/google_ads/keywords_for_keywords/task_post:
    post:
      ...
      operationId: post_dataforseo_keywords_data_google_ads_keywords_for_keywords_task_post
      requestBody:
        required: true
        content:
          application/json:
            schema:
              ...
              properties:
                ...
                target:
                  type: string
                  description: >-
                    target website optional field specify a website or URL to
                    get a list of keywords relevant to it; Note: if a website
                    url is specified, you will still get keywords relevant for
                    the entire website
                location_name:
                  type: string
                  description: >-
