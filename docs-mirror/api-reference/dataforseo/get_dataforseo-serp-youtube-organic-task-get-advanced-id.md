...
````yaml openapi/dataforseo.json GET /dataforseo/serp/youtube/organic/task_get/advanced/{id}
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/youtube/organic/task_get/advanced/{id}:
    get:
      ...
      description: >-
        Get YouTube Organic Results by id. Returns advanced YouTube Organic
        results for a previously posted task.
      operationId: get_dataforseo_serp_youtube_organic_task_get_advanced_id
      parameters:
        - name: id
          in: path
          required: true
