...
````yaml openapi/dataforseo.json POST /dataforseo/dataforseo_labs/google/keywords_for_app/live
openapi: 3.0.3
info:
  ...
  /dataforseo/dataforseo_labs/google/keywords_for_app/live:
    post:
      ...
      description: >-
        ...
        target app ranks on Google Play. You will obtain keyword data and
        discover the app’s ranking position for each returned keyword.
            ...
            schema:
              ...
              properties:
                app_id:
                  type: string
                  description: >-
                    id of the apps required field ID of the mobile application
