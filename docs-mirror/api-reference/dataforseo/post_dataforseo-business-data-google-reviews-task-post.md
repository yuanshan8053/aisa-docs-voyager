...
````yaml openapi/dataforseo.json POST /dataforseo/business_data/google/reviews/task_post
openapi: 3.0.3
info:
  ...
  /dataforseo/business_data/google/reviews/task_post:
    post:
      ...
      description: >-
        ...
        SERPs. The results are specific to the selected location (see [the List
        of
        ...
        parameters.
      operationId: post_dataforseo_business_data_google_reviews_task_post
      requestBody:
        required: true
        content:
          application/json:
                ...
                depth:
                  ...
                  description: >-
                    *parsing depth* optional field number of reviews in SERP we
                    ...
                    in a row default value: `10` maximum value: `4490` **Your
                ...
                sort_by:
                  ...
                  description: >-
                    *results sorting parameters* optional field you can use this
                    ...
                    `newest` – sort by newest first `highest_rating` – sort by
                    highest rating `lowest_rating` – sort by lowest rating
                    `relevant` – sort by relevance default value: `relevant`
                tag:
                  type: string
                  description: >-
