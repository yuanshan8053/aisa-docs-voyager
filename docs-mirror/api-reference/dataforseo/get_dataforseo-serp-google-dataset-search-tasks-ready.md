...
````yaml openapi/dataforseo.json GET /dataforseo/serp/google/dataset_search/tasks_ready
openapi: 3.0.3
info:
...
paths:
  /dataforseo/serp/google/dataset_search/tasks_ready:
    get:
      ...
      description: >-
        Get Dataset Search SERP Completed Tasks. Returns completed Google
        Dataset Search tasks that have not been collected yet.
      operationId: get_dataforseo_serp_google_dataset_search_tasks_ready
      responses:
        '200':
