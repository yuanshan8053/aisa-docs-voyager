...
````yaml openapi/dataforseo.json POST /dataforseo/ai_optimization/chat_gpt/llm_responses/live
openapi: 3.0.3
info:
...
paths:
  /dataforseo/ai_optimization/chat_gpt/llm_responses/live:
    post:
      ...
      description: >-
        Live ChatGPT LLM Responses endpoint allows you to retrieve structured
        responses from a specific ChatGPT AI model, based on the input
        parameters.
      operationId: post_dataforseo_ai_optimization_chat_gpt_llm_responses_live
      requestBody:
        required: true
        content:
          application/json:
              ...
              properties:
                ...
                max_output_tokens:
                  ...
                  description: >-
                    ...
                    value: 2048 Note: if web_search is set to true or the
                    reasoning model is specified in the request, the output
                    token count may exceed the specified max_output_tokens limit
                temperature:
                  type: number
                  description: >-
                ...
                web_search:
                  type: boolean
                  description: >-
                    enable web search optional field when enabled, the AI model
                    can access and cite current web information; default value:
                    false; Note: refer to the Models endpoint for a list of
                ...
                force_web_search:
                  ...
                  description: >-
                    ...
                    will be cited in the response Note #2: not supported in
                    reasoning models
                web_search_country_iso_code:
                  type: string
                  description: >-
                    ISO country code of the location optional field required if
                    web_search_city is specified; to enable this parameter,
                    web_search must also be enabled; when enabled, the AI model
                    will search the web from the country you specify; Note: not
                    supported in o3-mini, o1-pro, o1 models
                web_search_city:
                  type: string
                  description: >-
                    city name of the location optional field Note: specify
                    web_search_country_iso_code to use this parameter Note #2:
                    not supported in o3-mini, o1-pro, o1 models
                system_message:
                  type: string
                  description: >-
