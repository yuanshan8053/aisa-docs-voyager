...
````yaml openapi/perplexity-openapi.json POST /perplexity/sonar-reasoning-pro
openapi: 3.0.0
info:
...
paths:
  /perplexity/sonar-reasoning-pro:
    post:
      ...
      description: >-
        Reasoning model with Chain of Thought (CoT) for precise, step-by-step
        analysis backed by web search. Best for analytical and complex reasoning
        tasks. Uses model `sonar-reasoning-pro`.
          ...
          application/json:
            ...
            example:
              ...
              messages:
                - role: user
                  content: >-
                    Analyze whether Tesla stock is overvalued based on current
                    P/E ratio compared to industry averages
      responses:
        '200':
