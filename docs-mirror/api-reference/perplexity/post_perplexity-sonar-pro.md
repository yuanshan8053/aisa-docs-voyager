...
````yaml openapi/perplexity-openapi.json POST /perplexity/sonar-pro
openapi: 3.0.0
info:
...
paths:
  /perplexity/sonar-pro:
    post:
      ...
      description: >-
        Advanced search model supporting complex queries and multi-step
        follow-ups. Better for nuanced research questions. Uses model
        `sonar-pro`.
          ...
          application/json:
            ...
            example:
              ...
              messages:
                - role: user
                  content: >-
                    Compare the economic policies of the US and EU regarding AI
                    regulation in 2025-2026
      responses:
        '200':
